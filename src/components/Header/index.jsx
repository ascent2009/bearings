...
const Header = ({onClick}) => {
    ...
    return (
        <header className="header">
            ...
            <button type="button" className="header__top button" onClick={onClick}>Оставить заявку</button>
            </section>
            <section data-aos="fade-down" className="header__bottom">
                ...
                <button type="button" className="header__bottom button" onClick={onClick}>Оставить заявку</button>
            </section>
        </header>
    )
}
